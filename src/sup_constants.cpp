...
namespace SUP
{
	const std::wstring CLS_MAIN_FORM = L"tSkMainForm";
	const std::wstring CLS_CONVERSATION_FORM = L"TConversationForm";
	const std::wstring CLS_CHAT_ENTRY = L"TChatEntryControl";
